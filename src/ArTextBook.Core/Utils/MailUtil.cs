...
namespace Alva.ArTextBook.Utils
{
    public static class MailUtil
    {
        ...
        public static async Task SendMailAsync(string smtpserver, int port,
            bool enableSsl, string userName, string pwd,
            string nickName, string fromMail, string toMail,
