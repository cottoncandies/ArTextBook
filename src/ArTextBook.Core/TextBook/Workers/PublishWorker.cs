...
{
    [Repository]
    public class PublishWorker : WorkerBase
    {
        #region SQL
        private const string SelectPublish = @"
        select 
	        g.ng_id as Id,
        ...
        from atb_publish_t g left join sys_user_t uc on g.ng_ctor_id=uc.ng_id
