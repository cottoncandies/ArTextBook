...
{
    [Repository]
    public class SubjectWorker : WorkerBase
    {
        #region SQL
        private const string SelectSubject = @"
        select 
	        g.ng_id as Id,
        ...
        from atb_subject_t g left join sys_user_t uc on g.ng_ctor_id=uc.ng_id
